                ...
                <nav>
                    <div id="nav-left">
                        ...
                        if(App\Session::isAdmin()){
                            ?>
                            <a href="index.php?ctrl=admin&action=usersList">Voir la liste des gens</a>
                    ...
                    <?php
                        ...
                        if(App\Session::getUser()){
                            ?>
                            <a href="index.php?ctrl=forum&action=profile"><span class="fas fa-user"></span>&nbsp;<?= App\Session::getUser()?></a>
