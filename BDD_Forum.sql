...
-- Listage des données de la table forum.post : ~38 rows (environ)
INSERT INTO `post` (`id_post`, `texte`, `datePost`, `user_id`, `topic_id`, `lastModified`, `modifiedBy`) VALUES
	...
	(44, 'Réponse au sujet scientifique 2.', '2023-09-01 09:01:12', 7, 4, NULL, NULL),
	(45, 'Réponse au sujet scientifique 3.', '2023-09-01 09:01:12', 3, 4, NULL, NULL),
	(46, 'Discussion sur le football 1.', '2023-09-01 09:01:12', 4, 5, NULL, NULL),
	(47, 'Discussion sur le football 2.', '2023-09-01 09:01:12', 5, 5, NULL, NULL),
	(48, 'Discussion sur le football 3.', '2023-09-01 09:01:12', 6, 5, NULL, NULL),
	(49, 'Avis sur le dernier concert 1.', '2023-09-01 09:01:12', 7, 6, NULL, NULL),
	...
	(54, 'Recette de cuisine 3.', '2023-09-01 09:01:12', 7, 7, NULL, NULL),
	(58, 'Discussion sur l\'astronomie 1.', '2023-09-01 09:01:12', 6, 9, NULL, NULL),
	(59, 'Discussion sur l\'astronomie 2.', '2023-09-01 09:01:12', 7, 9, NULL, NULL),
	(60, 'Discussion sur l\'astronomie 3.', '2023-09-01 09:01:12', 3, 9, NULL, NULL),
	(61, 'Basketball 1.', '2023-09-01 09:01:12', 4, 10, NULL, NULL),
	(62, 'Basketball 2.', '2023-09-01 09:01:12', 5, 10, NULL, NULL),
	(63, 'Basketball 3.', '2023-09-01 09:01:12', 6, 10, NULL, NULL),
	(64, 'Critique musicale 1.', '2023-09-01 09:01:12', 7, 11, NULL, NULL),
	...
	(69, 'Recette asiatique 3.', '2023-09-01 09:01:12', 7, 12, NULL, NULL),
	...
	(96, '&lt;p&gt;Fait chier&lt;/p&gt;', '2023-09-08 20:10:02', 11, 20, NULL, NULL),
	(102, 'c important', '2023-09-09 16:30:00', 14, 21, NULL, NULL),
	(103, '&lt;p&gt;Pourquoi ici &ccedil;a marche&lt;/p&gt;', '2023-09-09 16:30:14', 14, 21, NULL, NULL),
	(107, '&lt;p&gt;Grave, shehh btrd&lt;/p&gt;', '2023-09-09 19:04:50', 14, 20, '2023-09-09 19:04:59', 'wesheu'),
	(108, '&lt;p&gt;Arreter wesh&lt;/p&gt;', '2023-09-09 19:08:37', 14, 20, NULL, NULL),
	(109, '&lt;p&gt;c pas cool wesh&lt;/p&gt;', '2023-09-09 19:08:45', 14, 20, NULL, NULL),
...
INSERT INTO `topic` (`id_topic`, `closed`, `titre`, `dateTopic`, `categorie_id`, `user_id`) VALUES
	...
	(5, 0, 'Football', '2023-09-01 08:53:18', 6, 5),
	(6, 0, 'Concerts locaux', '2023-09-01 08:53:18', 7, 6),
	(7, 0, 'Recettes de cuisine', '2023-09-01 08:53:18', 8, 7),
	(9, 0, 'Espace et astronomie', '2023-09-01 08:53:18', 5, 4),
	(10, 0, 'Basketball', '2023-09-01 08:53:18', 6, 5),
	...
	(21, 0, 'Je v&eacute;rifie un truc', '2023-09-09 16:30:00', 4, 14);
...
INSERT INTO `user` (`id_user`, `pseudo`, `password`, `dateInscription`, `role`, `email`, `bannedUntil`) VALUES
	...
	(5, 'Charlie', 'motdepasse3', '2023-09-01 08:49:16', 'utilisateur', 'charlie@example.com', NULL),
	(6, 'David', 'motdepasse4', '2023-09-01 08:49:16', 'utilisateur', 'david@example.com', NULL),
	(7, 'Eve', 'motdepasse5', '2023-09-01 08:49:16', 'utilisateur', 'eve@example.com', NULL),
	...
	(13, 'Roghan', '$2y$10$w2LsZ7EA2qsMiSS1nvbVFekdWPx7LlvciBpCOJi56laEQjjNHqbO.', '2023-09-07 15:45:19', 'ROLE_USER', 'p90svborz@gmail.com', NULL),
	(14, 'wesheu', '$2y$10$iFAX4QvSCN4qPGLisG4f6OpXXoJN/6IH/B7kDg0b07OBDMA6.xZHm', '2023-09-08 22:37:42', 'ROLE_USER', 'wesh@gmail.com', NULL);
